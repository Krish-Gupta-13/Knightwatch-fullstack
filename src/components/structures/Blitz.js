...
const Blitz = () => {
  ...
  const [time1, setTime1] = useState({ min: 3, sec: 0, count: 99 });
  const [time2, setTime2] = useState({ min: 3, sec: 0, count: 99 });
  ...
  const reset = () => {
    setTimer1(false);
    setTimer2(false);
    setTime1({ min: 3, sec: 0, count: 99 });
    setTime2({ min: 3, sec: 0, count: 99 });
    setMoves1(0);
    setMoves2(0);
    setTurn(-1);
  };
